<template>
  <div v-if="modelValue" class="fixed inset-0 z-50 isolate">
    <div class="ios-admin-overlay absolute inset-0" @click="$emit('update:modelValue', false)"></div>
    <div class="absolute z-50 right-0 top-0 h-full w-full max-w-xl ios-admin-modal-panel border-l shadow-2xl flex flex-col rounded-none rounded-l-[22px]">
