<template>
  <div class="fixed inset-0 z-50 overflow-y-auto isolate">
    <div class="flex items-center justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
      <!-- Overlay -->
      <div class="fixed inset-0 ios-admin-overlay transition-opacity" @click="$emit('close')"></div>

      <!-- Modal -->
      <div class="relative z-50 inline-block align-bottom ios-admin-modal-panel text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-2xl sm:w-full">
        <div class="px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
          <div class="sm:flex sm:items-start">
            <div class="mx-auto flex-shrink-0 flex items-center justify-center h-12 w-12 ios-admin-icon-badge sm:mx-0 sm:h-10 sm:w-10">
              <Icon 
