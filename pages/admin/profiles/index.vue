<template>
  <div>
    ...
    <div class="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-4 mb-4 sm:mb-6">
      <div>
        <h1 class="text-xl sm:text-2xl font-bold theme-text-primary">Gestión de Usuarios</h1>
        <p class="text-sm sm:text-base theme-text-secondary mt-0.5">Administra todos los usuarios del sistema</p>
      </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-4 gap-6 mb-6">
      <div class="ios-admin-stat-card">
        <div class="flex items-center">
          ...
          <div class="ml-4">
            <p class="text-sm font-medium theme-text-muted">Total Usuarios</p>
            <p class="text-2xl font-bold theme-text-primary">{{ usersSummary.total }}</p>
          </div>
        </div>
      </div>
      ...
      <div class="ios-admin-stat-card">
        <div class="flex items-center">
          ...
          <div class="ml-4">
            <p class="text-sm font-medium theme-text-muted">Administradores</p>
            <p class="text-2xl font-bold theme-text-primary">{{ usersSummary.admins }}</p>
          </div>
        </div>
      </div>
      ...
      <div class="ios-admin-stat-card">
        <div class="flex items-center">
          ...
          <div class="ml-4">
            ...
            <p class="text-2xl font-bold theme-text-primary">{{ usersSummary.active }}</p>
          </div>
        </div>
      </div>
      ...
      <div class="ios-admin-stat-card">
        <div class="flex items-center">
          ...
          <div class="ml-4">
            ...
            <p class="text-2xl font-bold theme-text-primary">{{ usersSummary.new }}</p>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="ios-admin-toolbar mb-4 sm:mb-6">
      <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
        ...
        <!-- Filtro por rol -->
        <div>
          <label class="block text-sm font-medium theme-text-secondary mb-1">Rol</label>
          <select
