import { defineComponent, computed, h, shallowRef, resolveComponent, inject, provide, toValue, mergeProps, unref, ref, watch, createVNode, resolveDynamicComponent, withCtx, renderSlot, createBlock, openBlock, toDisplayString, toRef, mergeModels, useModel, createCommentVNode, createTextVNode, hasInjectionContext, getCurrentInstance, cloneVNode, createElementBlock, isRef, onServerPrefetch, nextTick, defineAsyncComponent, useSSRContext, shallowReactive, Suspense, Fragment, createApp, renderList, useId, onErrorCaptured, reactive, effectScope, isReadonly, toRaw, useSlots, withModifiers, getCurrentScope, markRaw } from 'vue';
import { z as serialize, p as parseQuery, A as klona, B as defuFn, C as hasProtocol, D as isScriptProtocol, E as joinURL, F as isEqual, G as defu, H as withQuery, I as sanitizeStatusCode, J as withTrailingSlash, K as withoutTrailingSlash, L as getContext, n as createError$1, $ as $fetch$1, M as baseURL, N as createHooks, O as executeAsync, P as setCookie, i as getHeader, Q as toRouteMatcher, R as createRouter$1, S as destr, T as getRequestHeader, U as getCookie, V as deleteCookie } from '../_/nitro.mjs';
import { createPinia, setActivePinia, shouldHydrate } from 'pinia';
import { useRoute as useRoute$1, RouterView, createMemoryHistory, createRouter, START_LOCATION } from 'vue-router';
import { createServerClient, parseCookieHeader } from '@supabase/ssr';
import colors from 'tailwindcss/colors';
import { Icon, getIcon, loadIcon as loadIcon$1, _api, addAPIProvider, setCustomIconsLoader } from '@iconify/vue';
import { ssrRenderComponent, ssrRenderVNode, ssrRenderSlot, ssrRenderClass, ssrInterpolate, ssrRenderList, ssrRenderSuspense, ssrRenderAttrs, ssrRenderStyle } from 'vue/server-renderer';
...
const _routes = [
  {
    ...
    component: () => import('./about-Cw__yeFX.mjs')
  },
  {
    name: "index",
    path: "/",
    meta: __nuxt_page_meta$k || {},
    component: () => import('./index-PUPoAI_X.mjs')
  },
  {
    name: "login",
    path: "/login",
    meta: __nuxt_page_meta$j || {},
    component: () => import('./login-ehVLEMLf.mjs')
  },
  {
    name: "dashboard",
    path: "/dashboard",
    meta: __nuxt_page_meta$i || {},
    component: () => import('./dashboard-B4AQkrAs.mjs')
  },
  {
    name: "shop-cart",
    path: "/shop/cart",
    meta: { ...__nuxt_page_meta$h || {}, ...{ "middleware": "user-only" } },
    component: () => import('./cart-BfIR1SXO.mjs')
  },
  {
    name: "shop",
    path: "/shop",
    meta: __nuxt_page_meta$g || {},
    component: () => import('./index-Bro8QJco.mjs')
  },
  {
    name: "user",
    path: "/user",
    meta: { ...__nuxt_page_meta$f || {}, ...{ "middleware": "user-only" } },
    component: () => import('./index-BdNt1efZ.mjs')
  },
  {
    name: "admin",
    path: "/admin",
    meta: __nuxt_page_meta$e || {},
    component: () => import('./index-CR8Xci4-.mjs')
  },
  {
    name: "orders-id",
    path: "/orders/:id()",
    meta: __nuxt_page_meta$d || {},
    component: () => import('./_id_-DA8ykkzk.mjs')
  },
  {
    name: "user-orders",
    path: "/user/orders",
    meta: { ...__nuxt_page_meta$c || {}, ...{ "middleware": "user-only" } },
    component: () => import('./orders-SVyzYRxF.mjs')
  },
  {
    name: "unauthorized",
    path: "/unauthorized",
    meta: __nuxt_page_meta$b || {},
    component: () => import('./unauthorized-CuEcc8ae.mjs')
  },
  {
    name: "checkout-pending",
    path: "/checkout/pending",
    meta: { ...__nuxt_page_meta$a || {}, ...{ "middleware": "user-only" } },
    component: () => import('./pending-Dx4hTD_6.mjs')
  },
  {
    name: "checkout-success",
    path: "/checkout/success",
    meta: { ...__nuxt_page_meta$9 || {}, ...{ "middleware": "user-only" } },
    component: () => import('./success-CK7YbaOo.mjs')
  },
  {
    name: "admin-offers",
    path: "/admin/offers",
    meta: __nuxt_page_meta$8 || {},
    component: () => import('./index-g7oT3VU6.mjs')
  },
  {
    name: "admin-orders",
    path: "/admin/orders",
    meta: __nuxt_page_meta$7 || {},
    component: () => import('./index-9Dka5Mpd.mjs')
  },
  {
    name: "shop-category-id",
    path: "/shop/category/:id()",
    meta: __nuxt_page_meta$6 || {},
    component: () => import('./_id_-iz8swzZ8.mjs')
  },
  {
    name: "admin-products",
    path: "/admin/products",
    meta: __nuxt_page_meta$5 || {},
    component: () => import('./index-DyE-bPzi.mjs')
  },
  {
    name: "admin-profiles",
    path: "/admin/profiles",
    meta: __nuxt_page_meta$4 || {},
    component: () => import('./index-B77ONW5v.mjs')
  },
  {
    name: "admin-customers",
    path: "/admin/customers",
    meta: __nuxt_page_meta$3 || {},
    component: () => import('./index-AQOe5QuY.mjs')
  },
  {
    name: "admin-inventory",
    path: "/admin/inventory",
    meta: __nuxt_page_meta$2 || {},
    component: () => import('./index-BIiBWY5F.mjs')
  },
  {
    name: "admin-providers",
    path: "/admin/providers",
    meta: __nuxt_page_meta$1 || {},
    component: () => import('./index-BsfC5s6e.mjs')
  },
  {
    name: "admin-categories",
    path: "/admin/categories",
    meta: __nuxt_page_meta || {},
    component: () => import('./index-BWUgj4_D.mjs')
  }
];
...
const admin_45global = /* @__PURE__ */ defineNuxtRouteMiddleware(async (to) => {
  if (!to.path.startsWith("/admin")) return;
  return;
});
const require_45auth_45global = /* @__PURE__ */ defineNuxtRouteMiddleware((_to) => {
  return;
});
...
const globalMiddleware = [
  validate,
  admin_45global,
  require_45auth_45global,
  manifest_45route_45rule
];
const namedMiddleware = {
  auth: () => import('./auth-C8oE6roO.mjs'),
  "user-only": () => import('./user-only-BKYIBan1.mjs')
};
...
async function fetchWithRetry(req, init) {
  ...
  for (let attempt = 1; attempt <= retries; attempt++) {
    try {
      ...
      if ((_a2 = init == null ? void 0 : init.signal) == null ? void 0 : _a2.aborted) {
        throw error;
      }
      if (attempt === retries) {
  ...
  setup() {
    addRouteMiddleware(
      ...
      /* @__PURE__ */ defineNuxtRouteMiddleware((to) => {
        ...
        const isExcluded = (_a2 = [...exclude ?? [], login, callback]) == null ? void 0 : _a2.some((path) => {
          const regex = new RegExp(`^${path.replace(/\*/g, ".*")}$`);
          return regex.test(to.path);
        });
...
const _sfc_main$c = /* @__PURE__ */ Object.assign({ inheritAttrs: false }, {
  ...
  setup(__props) {
    ...
    const ui = computed(() => {
      var _a2;
      return tv({ extend: tv(theme$6), ...((_a2 = appConfig2.ui) == null ? void 0 : _a2.chip) || {} })({
        color: props.color,
        size: size.value,
...
const _sfc_main$b = /* @__PURE__ */ Object.assign({ inheritAttrs: false }, {
  ...
  setup(__props) {
    ...
    const ui = computed(() => {
      var _a2;
      return tv({ extend: tv(theme$5), ...((_a2 = appConfig2.ui) == null ? void 0 : _a2.avatar) || {} })({
        size: size.value
      });
    });
...
const _sfc_main$7 = {
  ...
  setup(__props, { emit: __emit }) {
    ...
    const ui = computed(() => {
      var _a2;
      return tv({ extend: tv(theme$2), ...((_a2 = appConfig2.ui) == null ? void 0 : _a2.progress) || {} })({
          ...
          if (_push2) {
            ...
            if (hasSteps.value) {
              ...
              ssrRenderList(__props.max, (step, index2) => {
                var _a4;
                _push2(`<div class="${ssrRenderClass(ui.value.step({ class: (_a4 = props.ui) == null ? void 0 : _a4.step, step: stepVariant(index2) }))}"${_scopeId}>`);
            ...
            _push2(ssrRenderComponent(unref(TooltipProvider), tooltipProps.value, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  ...
                  return [
                    __props.toaster !== null ? (openBlock(), createBlock(_sfc_main$5, mergeProps({ key: 0 }, toasterProps.value), {
                      default: withCtx(() => [
                        renderSlot(_ctx.$slots, "default")
                      ]),
                      _: 3
...
const layouts = {
  admin: defineAsyncComponent(() => import('./admin-QxhdULOY.mjs').then((m) => m.default || m)),
  default: defineAsyncComponent(() => import('./default-tEdNNdeE.mjs').then((m) => m.default || m))
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      const _component_Icon = __nuxt_component_1$1;
      const _component_NuxtLink = __nuxt_component_0;
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "min-h-screen bg-gradient-to-br from-pink-50 via-white to-purple-50 flex items-center justify-center p-4" }, _attrs))}><div class="max-w-md w-full text-center"><div class="mb-8"><div class="w-24 h-24 bg-gradient-to-r from-pink-500 to-purple-600 rounded-full flex items-center justify-center mx-auto mb-6">`);
      _push(ssrRenderComponent(_component_Icon, {
        name: "heroicons:exclamation-triangle",
        class: "w-12 h-12 text-white"
      }, null, _parent));
      _push(`</div><h1 class="text-4xl font-bold text-gray-900 mb-4"><span class="bg-gradient-to-r from-pink-600 to-purple-600 bg-clip-text text-transparent">${ssrInterpolate(unref(error).statusCode)}</span></h1><h2 class="text-2xl font-semibold text-gray-700 mb-4">${ssrInterpolate(unref(error).statusMessage)}</h2><p class="text-gray-600 mb-8">${ssrInterpolate(unref(error).message || "Algo salió mal. Por favor, intenta de nuevo.")}</p></div><div class="space-y-4"><button class="w-full bg-gradient-to-r from-pink-500 to-purple-600 text-white px-6 py-3 rounded-full font-medium hover:from-pink-600 hover:to-purple-700 transition-all duration-300 shadow-lg hover:shadow-xl transform hover:-translate-y-0.5"> Intentar de Nuevo </button>`);
      _push(ssrRenderComponent(_component_NuxtLink, {
        to: "/",
        class: "block w-full border-2 border-pink-500 text-pink-600 px-6 py-3 rounded-full font-medium hover:bg-pink-500 hover:text-white transition-all duration-300"
      }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
...
export { __nuxt_component_1$1 as _, __nuxt_component_0 as a, useNuxtApp as b, useAppConfig as c, useFormField as d, entry$1 as default, useButtonGroup as e, useComponentIcons as f, _sfc_main$d as g, _sfc_main$b as h, useLocale as i, usePortal as j, isArrayOfArray as k, looseToNumber as l, get as m, navigateTo as n, compare as o, _sfc_main$c as p, getDisplayValue as q, useRoute as r, useHead as s, tv as t, useRouter as u, useToast as v, __nuxt_component_0$1 as w, defineNuxtRouteMiddleware as x, useSupabaseUser as y, useState as z };
